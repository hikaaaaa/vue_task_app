...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rails/rails/issues", "changelog_uri" => "https://github.com/rails/rails/releases/tag/v6.0.2.1", "documentation_uri" => "https://api.rubyonrails.org/v6.0.2.1/", "mailing_list_uri" => "https://groups.google.com/forum/#!forum/rubyonrails-talk", "source_code_uri" => "https://github.com/rails/rails/tree/v6.0.2.1" } if s.respond_to? :metadata=
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<actionview>.freeze, ["= 6.0.2.1"])
      s.add_runtime_dependency(%q<activemodel>.freeze, ["= 6.0.2.1"])
      s.add_runtime_dependency(%q<activerecord>.freeze, ["= 6.0.2.1"])
      s.add_runtime_dependency(%q<actionmailer>.freeze, ["= 6.0.2.1"])
      s.add_runtime_dependency(%q<activejob>.freeze, ["= 6.0.2.1"])
      s.add_runtime_dependency(%q<actioncable>.freeze, ["= 6.0.2.1"])
      s.add_runtime_dependency(%q<activestorage>.freeze, ["= 6.0.2.1"])
      s.add_runtime_dependency(%q<actionmailbox>.freeze, ["= 6.0.2.1"])
      s.add_runtime_dependency(%q<actiontext>.freeze, ["= 6.0.2.1"])
      s.add_runtime_dependency(%q<railties>.freeze, ["= 6.0.2.1"])
      ...
      s.add_dependency(%q<actionmailer>.freeze, ["= 6.0.2.1"])
      s.add_dependency(%q<activejob>.freeze, ["= 6.0.2.1"])
      s.add_dependency(%q<actioncable>.freeze, ["= 6.0.2.1"])
      s.add_dependency(%q<activestorage>.freeze, ["= 6.0.2.1"])
      s.add_dependency(%q<actionmailbox>.freeze, ["= 6.0.2.1"])
      s.add_dependency(%q<actiontext>.freeze, ["= 6.0.2.1"])
      s.add_dependency(%q<railties>.freeze, ["= 6.0.2.1"])
